...
knitr::include_graphics(here("slides/intro_r_day1_files/figs/mobile_usage_prediction_map_nigeria.png"))
...
knitr::include_graphics(here("slides/intro_r_day1_files/figs/rstudio_layout.png"))
```

## R Scripts, R-Notebooks {.smaller}
...
knitr::include_graphics(here("slides/intro_r_day1_files/figs/quarto_doc.png"))

```
:::
:::

## Live Coding Session 1: Creating new Quarto file {.smaller}
...
knitr::include_graphics(here("slides/intro_r_day1_files/figs/lightbulb_analogy.png"))
```
:::
:::
...
## Basic Syntax: assignment {.smaller}
...
## Basic syntax: operators {.smaller}
...
-   Manually write out sequence using `c()`
...
2.  Create a new variable `z` as the product of `x` and `y`.
...
2.  Generate a sequence of all even numbers between 0 and 100.
...
## Explore `data frame` characteristics {.smaller}
...
2.  Calculate the mean of this generated sample. How does this sample mean relate to the population mean (hint: population mean = 10) of the distribution?
...
-   Homework: please complete all exercises in problem set 1 independently
