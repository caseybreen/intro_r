...
knitr::include_graphics(path = here("slides/session3_workflow_files/figures/git_github.png"))
```
:::
::::::
...
knitr::include_graphics(path = here("slides/session3_workflow_files/figures/github_overview.png"))
```
...
knitr::include_graphics(path = here("slides/session3_workflow_files/figures/overleaf.png"))
```
:::
::::::
